...
![LOW 模式的跑分](platform-power-policy/low.jpg)

* auto 模式的跑分

![auto 模式的跑分](platform-power-policy/auto.jpg)

* high 模式的跑分

![high 模式的跑分](platform-power-policy/high.jpg)
...
测试笔记本下 intel 核显跑分如下
![图片](platform-power-policy/gxn.png)
...
![图片](platform-power-policy/s-tui.jpg)
